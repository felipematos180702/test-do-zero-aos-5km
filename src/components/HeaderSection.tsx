...
export function HeaderSection() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full bg-[#EFECE6]/90 backdrop-blur-md border-b border-[#E5DFD4] transition-all duration-300">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 py-2 sm:py-3 flex items-center justify-between gap-4">
        ...
        <button
          ...
          className="bg-[#414A36] hover:bg-[#343b2b] text-[#EFECE6] px-4 py-2 sm:px-6 sm:py-2.5 rounded-full text-xs sm:text-sm font-bold tracking-wide transition-all duration-300 shadow-sm active:scale-95 whitespace-nowrap"
        >
